 ...
 */
// FIXME: LMP: Hardcode localhost server location for testing purposes
// DiagramEditor.prototype.drawDomain = 'https://embed.diagrams.net/';
// DiagramEditor.prototype.drawDomain = 'http://localhost/drawio.git/src/main/webapp/';
...
DiagramEditor.prototype.getFrameUrl = function()
{
	...
	// FIXME: LMP: drop additional configuration elements being added for now
	var url = this.drawDomain ;
...
{
	console.log( "#" + Math.random() + ": MWVE drawioHandleMessage: (" + msg.event + ")" );
